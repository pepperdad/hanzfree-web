    ...
    <footer className='w-full h-[200px] px-3 py-2 bg-blue-700 text-slate-100 flex flex-col md:block'>
      ...
      <div className='mt-2'>
        <div className='md:w-full flex flex-col gap-y-2 md:flex-row justify-center md:gap-12 md:my-3'>
          <div className='md:min-w-40 flex flex-row ml-2 md:ml-0 md:flex-col items-center'>
          ...
          {/* <div className='md:min-w-40 flex flex-row ml-8 md:ml-0 md:flex-col items-center'>
          ...
          <div className='flex flex-row items-center ml-2 md:ml-0 md:min-w-40 md:flex-col'>
